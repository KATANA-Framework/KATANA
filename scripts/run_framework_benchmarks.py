...
SCENARIOS: Dict[str, Dict[str, Any]] = {
    ...
    "json-small": {
        "name": "JSON Small Object",
        "benchmark_name": "wrk json GET /json keepalive",
        "wrk_script": "test/load/scripts/json_get.lua",
        "wrk_threads": 4,
        "wrk_connections": 512,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
    ...
    "echo-json": {
        "name": "JSON Echo Transform",
        "benchmark_name": "wrk echo POST /echo keepalive",
        "wrk_script": "test/load/scripts/echo_post.lua",
        "wrk_threads": 4,
        "wrk_connections": 512,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
    ...
    "stats-128": {
        "name": "JSON Stats 128 doubles",
        "benchmark_name": "wrk stats POST /compute/stats keepalive",
        "wrk_script": "test/load/scripts/stats_post.lua",
        "wrk_threads": 4,
        "wrk_connections": 512,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
    ...
    "db-point-select": {
        "name": "DB Point SELECT + JSON",
        "benchmark_name": "wrk db GET /items/{id}",
        "wrk_script": "test/load/scripts/db_point_select.lua",
        "wrk_threads": 4,
        "wrk_connections": 256,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
    ...
    "db-list": {
        "name": "DB List SELECT 20 rows + JSON",
        "benchmark_name": "wrk db GET /items?limit=20",
        "wrk_script": "test/load/scripts/db_list.lua",
        "wrk_threads": 4,
        "wrk_connections": 256,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
    ...
    "db-insert-returning": {
        "name": "DB INSERT + RETURNING + JSON",
        "benchmark_name": "wrk db POST /items",
        "wrk_script": "test/load/scripts/db_insert_returning.lua",
        "wrk_threads": 4,
        "wrk_connections": 256,
        "wrk_duration_sec": 30,
        "pipeline_depth": None,
