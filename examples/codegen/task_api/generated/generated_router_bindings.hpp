...
// Dispatch for /tasks
inline katana::result<katana::http::response> dispatch_list_tasks(
...
// Dispatch for /tasks
inline katana::result<katana::http::response> dispatch_create_task(
    const katana::http::request& req, katana::http::request_context& ctx, api_handler& handler) {
...
inline katana::result<katana::http::response> dispatch_get_task(const katana::http::request& req,
...
// Dispatch for /tasks/{id}
inline katana::result<katana::http::response> dispatch_update_task(
    const katana::http::request& req, katana::http::request_context& ctx, api_handler& handler) {
...
// Dispatch for /tasks/{id}
inline katana::result<katana::http::response> dispatch_delete_task(
    const katana::http::request& req, katana::http::request_context& ctx, api_handler& handler) {
...
inline katana::result<katana::http::response> dispatch_batch_create_tasks(
    const katana::http::request& req, katana::http::request_context& ctx, api_handler& handler) {
...
inline katana::result<katana::http::response> dispatch_search_tasks(
    const katana::http::request& req, katana::http::request_context& ctx, api_handler& handler) {
