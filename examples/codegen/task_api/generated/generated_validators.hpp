...
[[nodiscard]] inline std::optional<validation_error> validate_CreateTaskRequest(const CreateTaskRequest& obj) {
    ...
    if (obj.description && obj.description->size() > CreateTaskRequest::metadata::DESCRIPTION_MAX_LENGTH) {
...
[[nodiscard]] inline std::optional<validation_error> validate_UpdateTaskRequest(const UpdateTaskRequest& obj) {
    if (obj.title && !obj.title->empty() && obj.title->size() < UpdateTaskRequest::metadata::TITLE_MIN_LENGTH) {
    ...
    if (obj.description && obj.description->size() > UpdateTaskRequest::metadata::DESCRIPTION_MAX_LENGTH) {
...
[[nodiscard]] inline std::optional<validation_error> validate_SearchRequest(const SearchRequest& obj) {
    if (obj.title_contains && !obj.title_contains->empty() && obj.title_contains->size() < SearchRequest::metadata::TITLE_CONTAINS_MIN_LENGTH) {
    ...
    if (obj.title_contains && obj.title_contains->size() > SearchRequest::metadata::TITLE_CONTAINS_MAX_LENGTH) {
