...
**Честный итог**: после серии оптимизаций KATANA
...
- KATANA соответствует сборке с оптимизациями этой серии (шардированные метрики, известное поле X-Request-Id, PG-пайплайнинг, 4 reactor-соединения на executor, ленивые аллокации таймера/очередей).
