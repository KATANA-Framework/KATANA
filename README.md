...
<!-- LATEST_UPDATE_START -->
* 01.12 06:59 — Fix io_buffer aligned storage definition and deleter (0cc9a9f)
<!-- LATEST_UPDATE_END -->
...
<!-- BENCH_SUMMARY_START -->
* Отчёт сгенерирован 2025-12-01 03:40:31.
* Keep-alive: throughput 11559.78 req/s, p99 0.139 ms, 339692 samples.
* Масштабирование: 128 коннектов — 271322.4 req/s; 8 потоков — 197238 req/s.
* Устойчивость: sustained 40257.787 req/s, всего 201300 requests.
<!-- BENCH_SUMMARY_END -->
