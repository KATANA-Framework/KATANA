...
<!-- LATEST_UPDATE_START -->
* 03.12 12:38 — Update README.md (1e52c57)
<!-- LATEST_UPDATE_END -->
...
<!-- BENCH_SUMMARY_START -->
* Отчёт сгенерирован 2025-12-03 08:49:55.
* Keep-alive: throughput 11509.05 req/s, p99 0.16 ms, 321905 samples.
* Масштабирование: 128 коннектов — 260648.4 req/s; 8 потоков — 205334.5 req/s.
* Устойчивость: sustained 39676.866 req/s, всего 198395 requests.
<!-- BENCH_SUMMARY_END -->
